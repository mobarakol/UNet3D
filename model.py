...
#from BuildingBlocks import Decoder, FinalConv, DoubleConv, ExtResNetBlock
...
class UNet3D(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, f_maps=16, layer_order='crg', num_groups=8, isSoftmax=False,
                 **kwargs):
